...
const vancouverEast = ({downtownPosts}) => {
    return (
      <>
      <Nav />
     <div className='bg-b-b w-screen h-auto min-h-screen pt-36'>
       <h1 className='text-primary text-2xl lg:text-3xl font-title text-center mb-5'>Downtown Area</h1>
...
export async function getStaticProps(){
    const downtownPosts = await getDowntownPosts();
    return {
        props: {downtownPosts},
    }
}
