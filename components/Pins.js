...
const Pins = ({data, setPopupInfo}) => {
    return data.map(info => (
        ...
        {/* <svg onClick={()=> setPopupInfo(info)} className='w-8 h-8 transform -translate-x-4 -translate-y-7' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#E2B15F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11.5" cy="8.5" r="5.5"/><path d="M11.5 14v7"/></svg>           */}
