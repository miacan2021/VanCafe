...
const Hero = () => {
    return (
        <div className="w-screen flex md:flex-row flex-col">
            <div className="lg:block absolute top-1/2 left-1/2 w-4/12 max-w-md transform -translate-y-1/2 -translate-x-1/2 border border-primary
             rounded-full pt-3 pb-1 hidden p-3
            ">
            <Image 
            src={HeroImg}
            ...
            <div className="w-11/12 md:w-6/12 m-auto lg:ml-24 flex flex-col items-center text-center">
            ...
            <div className="w-screen md:w-6/12 h-screen bg-b-p border border-primary flex flex-col items-center lg:items-end justify-center">
             <div className="w-11/12 md:w-6/12 m-auto lg:mr-24 flex flex-col items-center text-center">
